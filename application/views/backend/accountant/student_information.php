            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>index.php?librarian/student_marksheet/<?php echo $row['student_id'];?>">
                        ...
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?librarian/student/<?php echo $class_id;?>/delete/<?php echo $row['student_id'];?>');">
