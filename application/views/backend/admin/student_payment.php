...
<div class="panel panel-gradient" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
					 <?php echo get_phrase('payment_information_page'); ?>
					</div>
					</div>
			...
			<div class="tab-content">
				...
				<div class="row">
					<div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('add_invoice');?></button>
                            </div>
                        </div>
                    </div>
