               ...
               <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>index.php?admin/generateidcard/<?php echo $row['teacher_id'];?>" target="_blank" <button type="button" class="btn btn-success btn-sm dropdown-toggle"><?php echo get_phrase('generate_ID_card');?></button></a>								
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
