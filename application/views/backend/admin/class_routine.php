 ...
 <div class="panel panel-gradient" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
					 <?php echo get_phrase('class_routine_information_page'); ?>
					</div>
					</div>
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/class_routine/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="fa fa-save"></i><?php echo get_phrase('add_class_routine');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
