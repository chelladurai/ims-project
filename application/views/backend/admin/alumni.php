 ...
 <div class="panel panel-gradient" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
					 <?php echo get_phrase('alumni_information_page'); ?>
					</div>
					</div>
...
<br>
           &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_alumni_add/');" 
            	...
            	<?php echo get_phrase('add_new_alumni');?>
                </a> 
                <br><br><br>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-primary pull-right" role="menu">
                                        ...
                                        <!-- alumni EDITING LINK -->
                                        <li>
                                        	<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_alumni_edit/<?php echo $row['alumni_id'];?>');">
                                        ...
                                        <!-- alumni DELETION LINK -->
                                        <li>
                                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/alumni/delete/<?php echo $row['alumni_id'];?>');">
