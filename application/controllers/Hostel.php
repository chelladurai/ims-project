...
class hostel extends CI_Controller
{
    ...
    function student_marksheet_print_view($student_id , $exam_id) {
        ...
        $this->load->view('backend/hostel/student_marksheet_print_view', $page_data);
    }
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?hostel/student_add/' . $data['class_id'], 'refresh');
        }
        if ($param2 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?hostel/student_information/' . $param1, 'refresh');
        } 
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?hostel/subject/'.$data['class_id'], 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['class_id']   = $this->input->post('class_id');
        ...
        if ($param1 == 'delete') {
            ...
            redirect(base_url() . 'index.php?hostel/subject/'.$param3, 'refresh');
        }
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                redirect(base_url() . 'index.php?hostel/marks/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'index.php?hostel/marks/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            ...
            redirect(base_url() . 'index.php?hostel/marks/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function backup_restore($operation = '', $type = '')
    {
        ...
        if ($operation == 'restore') {
            ...
            redirect(base_url() . 'index.php?hostel/backup_restore/', 'refresh');
        }
        if ($operation == 'delete') {
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?hostel/class_routine/', 'refresh');
        }
    ...
    {
        if($this->session->userdata('hostel_login')!=1)redirect('login' , 'refresh');
        ...
        if($_POST)
        {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?hostel/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id , 'refresh');
        }
        $page_data['date']     =    $date;
    ...
    {
        redirect(base_url() . 'index.php?hostel/manage_attendance/'.$this->input->post('date').'/'.
    ...
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?hostel/book', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['description'] = $this->input->post('description');
...
/**********MANAGE LOAN APPLICATIONS *******************/
    function loan_applicant($param1 = '', $param2 = '' , $param3 = '')
    {
		...
		if ($param1 == 'do_update') {
            ...
            redirect(base_url() . 'index.php?hostel/loan_applicant'.$data['assignment_id'], 'refresh');
			}
    ...
    function loan_approval($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            move_uploaded_file($_FILES["file_name"]["tmp_name"], "uploads/loan_applicant/" . $_FILES["file_name"]["name"]);
			$this->session->set_flashdata('flash_message' , get_phrase('loan_application_submitted_successfully'));
            redirect(base_url() . 'index.php?hostel/loan_approval' , 'refresh');
        }
		if ($param1 == 'do_update') {
            ...
            $this->db->update('loan', $data);
			 $this->session->set_flashdata('flash_message' , get_phrase('data_updated_successfully'));
            redirect(base_url() . 'index.php?hostel/loan_approval'.$data['assignment_id'], 'refresh');
			}
    ...
    function assignment($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?hostel/assignment' , 'refresh');
        }
		if ($param1 == 'do_update') {
             $data['timestamp']     = $this->input->post('timestamp');
            $data['title']         = $this->input->post('title');
            ...
            $this->db->update('assignment', $data);
			 $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?hostel/assignment/'.$data['assignment_id'], 'refresh');
			}
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?hostel/noticeboard/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title']     = $this->input->post('notice_title');
            $data['notice']           = $this->input->post('notice');
    ...
    function help_link($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?hostel/help_link', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['title']         = $this->input->post('title');
            $data['link'] = $this->input->post('link');
    ...
    function document($do = '', $document_id = '')
    {
        ...
        if ($do == 'upload') {
            ...
            redirect(base_url() . 'hostel/manage_document', 'refresh');
        }
        if ($do == 'delete') {
    ...
    function study_material($task = "", $document_id = "")
    {
        ...
        if ($task == "create")
        {
            ...
            redirect(base_url() . 'index.php?hostel/study_material' , 'refresh');
        }
        ...
        if ($task == "delete")
        {
            ...
            redirect(base_url() . 'index.php?hostel/study_material');
        }
